...
from .cargos import cargos1
from .cargos2 import cargos2
...
class kick(discord.ui.View):
    ...
    async def confirmkick(self, button: discord.ui.Button, interaction: discord.Interaction):
        ...
        if discord.utils.get(interaction.guild.roles, id = configData['roles']['staff']['donos']) in interaction.user.roles\
...
class cmdstf(discord.ui.View):
    ...
    async def advertência(self, button: discord.ui.Button, interaction: discord.Interaction):
        ...
        await interaction.response.send_message('O que ira fazer?', ephemeral = True, view = adv(self.bot))
    ...
    async def cargos(self, button: discord.ui.Button, interaction: discord.Interaction):
        ...
        or discord.utils.get(interaction.guild.roles, id = configData['roles']['equipes']['equipereg']['regchefe']) in interaction.user.roles:
