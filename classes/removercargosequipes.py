        ...
        match select.values[0]:
            ...
            case 'Chefe Div':
                ...
                or gerente in interaction.user.roles:
                    ...
                    e.add_field(name = 'Qual cargo vai ser removido ', value = promoters.mention, inline = False)
            ...
            case 'Divulgação':
                ...
                e.add_field(name = 'Qual cargo vai ser removido ', value = divulgação.mention, inline = False)
        ...
        match select.values[0]:
            ...
            case 'Chefe de midia':
                ...
                or gerente in interaction.user.roles:
                    ...
                    e.add_field(name = 'Qual cargo vai ser removido ', value = chefemidia.mention, inline = False)
            ...
            case 'Equipe de midia':
                ...
                e.add_field(name = 'Qual cargo vai ser removido ', value = equipemidia.mention, inline = False)
